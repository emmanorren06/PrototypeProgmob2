package prototypeprogmob.com.Network;
...
public interface GetDataService {
    ...
    Call<ArrayList<MhsSI>> getMhsAll(@Path("nim_progmob") String nim_progmob);
    ...
    @FormUrlEncoded
    @POST("/api/progmob/mahasiswa/Updatewhitefoto")
    ...
    @FormUrlEncoded
    @POST("/api/progmob/mahasiswa/createfoto")
    Call<DefaultResult> insert_foto_mahasiswa(
            @Field("id") String id,
            @Field("nim") String nim,
            @Field("nama") String nama,
            @Field("alamat") String alamat,
